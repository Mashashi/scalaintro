...
object s04hierarchydecomposition {
  ...
  to add a new method.
 	*/
 	...
 	val Num = Number(1)                       //> Num  : week4.s04hierarchydecomposition.Number = Number(1)
 	def eval(e : Expr) : Int = e match{
 		case Number(n) => n
 		case Sum(e1, Num) if Num.n ==1 => 1
 		case Sum(e1, e2) => eval(e1) + eval(e2)
 	}                                         //> eval: (e: week4.s04hierarchydecomposition.Expr)Int
 	
 	eval(Sum(Number(5),Number(1)))            //> res0: Int = 1
